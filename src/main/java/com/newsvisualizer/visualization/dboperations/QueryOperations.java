...
public class QueryOperations {
    ...
    public List<AccernData> getStoriesByGivenSector(String sector, int threshold) {
    ...
    public static void main(String[] args) {
        ...
        List<AccernData> storiesByGivenSector = ops.getStoriesByGivenSector("Technology", 300);
